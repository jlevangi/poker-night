...
def get_players() -> Dict[str, Any]:
    ...
    players = entry_service.get_all_players_summary_stats()
...
def get_all_players_details() -> Dict[str, Any]:
    ...
    """
    entry_service = EntryService()
    players = entry_service.get_all_players()
    return jsonify([player.to_dict() for player in players])
...
def add_player_api() -> Dict[str, Any]:
    ...
    entry_service = EntryService()
    player = entry_service.add_player(name)
    if player:
        stats = entry_service.get_player_overall_stats(player.player_id)
...
def get_player_stats_api(player_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        stats = entry_service.get_player_overall_stats(player_id)
...
def get_player_history_api(player_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        history = entry_service.get_player_session_history(player_id)
...
def increment_seven_two_wins_api(player_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if entry_service.increment_seven_two_wins(player_id):
            stats = entry_service.get_player_overall_stats(player_id)
            return jsonify(stats.to_dict())
...
def decrement_seven_two_wins_api(player_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if entry_service.decrement_seven_two_wins(player_id):
            stats = entry_service.get_player_overall_stats(player_id)
            return jsonify(stats.to_dict())
